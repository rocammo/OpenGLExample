...
int main () {
    ...
    GLuint programID = ShaderUtil::createProgam("../assets/vertexshader.vs", "../assets/fragmentshader.fs");

    //declare the data to upload
    const GLfloat vertices[] = {
            //2 triangles, 3 vertices per triangle, 3 floats per vertex
            //1.
            -0.5f, -0.5f, 0,
            0.5f, -0.5f, 0,
            -0.5f, 0.5f, 0,
    ...
    const GLfloat colors[] {
            //2 triangles, 3 vertices per triangle, 1 color per vertex, 4 "floats" per color RGBA
            //1.
            0,1,0,
            0,1,0,
            0,1,0,
